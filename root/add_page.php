...
require MYSQL;
$page_titile = 'Add a Site Content Page';
...
if (empty($add_page_errors)) {
	$sql = "INSERT INTO pages (categories_id, title, description, content)
			VALUES ($category, '$title', '$desc', '$content')";
	$result = mysqli_query($dbc, $sql);
	
	if (mysqli_affected_rows($dbc) === 1) {
		echo '<div class="alert alert-success"><h3>The page has been added!</h3></div>';
		// o array Post e limpado para que os valores do formulario nao permanecam
		$_POST = array();
	} else {
